...
void setup(){
  ...
  level2 = minim.loadSnippet("Netherworld Shanty_level2.wav");
  level3 = minim.loadSnippet("Netherworld Shanty_level3.wav");
...
class Game{
  ...
  Scoreboard sb;
  //CSVWriter csv;
  //gamestate: 0='Setup', 1='General Gameplay', 2='End game screen', 3='Press any key to start', 4='Story Screen 1', 5='Story Screen 2'
  int gamestate;
